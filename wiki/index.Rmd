...
Moved the code base to a private [GitHub](https://github.com/PietaSchofield/pietalib) repository like the SpikeNorm one
...
- Added a function to save a list of package citations to a bib file for importing into 
  endnote
